...
def get_actor():
    ...
    conv2d_2 = layers.Conv2D(
        ...
        activation="relu")(
        conv2d_1)
    maxpool_1 = layers.MaxPooling2D(
        pool_size=(2, 2),
        strides=(2, 2),
        padding='valid')(
        conv2d_2)
    conv2d_3 = layers.Conv2D(
        filters=num_filters_blick2,
...
def get_critic():
    ...
    state_out = layers.Dense(num_fc_units, activation="relu")(fc2)
